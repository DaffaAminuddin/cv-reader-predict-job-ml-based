...
#load save files ==========================================================
rf_classsifier = pickle.load(open('models/rf_classifier_categorization.pkl', 'rb'))
rf_vectorizer = pickle.load(open('models/tfidf_vectorizer_categorization.pkl','rb'))
...
def predict_category(resume_text):
    ...
    resume_tfidf = rf_vectorizer.transform([resume_text])
    predicted_category = rf_classsifier.predict(resume_tfidf)[0]
...
def pred():
    if 'resume' in request.files:
        ...
        if filename.endswith('.pdf'):
            ...
            return render_template('main.html', massage="Format file salah, silakan upload file berformat PDF, TXT atau docx.")
        ...
        return render_template('main.html', predicted_category = predicted_category, name = name, phone = phone, email = email, extracted_skills = extracted_skills, extracted_education = extracted_education)
    else:
        return render_template('main.html', massage = "CV belum terupload")
# python main ==============================================================
